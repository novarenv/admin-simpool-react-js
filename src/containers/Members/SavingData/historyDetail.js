...
export default class SavingDataHistoryDetail extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <ContentWrapper ref={ref => this.el = ref}>
        ...
        <div className="content-heading">
          <div>Detail Savings History</div>
        </div>
        ...
        <Card className="card-default">
          <CardBody>
            ...
            <form className="form-font-size mt-3" onSubmit={this.onSubmit}>
              ...
              <Link to="/simpool/member/saving-data-history-edit">
                <Button outline className="mt-3 col-12" color="warning" type="submit" tabIndex={7}>Edit Savings History</Button>
              </Link>
            </form>
          </CardBody>
        </Card>
