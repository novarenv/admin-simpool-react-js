...
export function loginUser(payload, onLoginSuccess, onLoginFailed, onLoginOtpSuccess, loginOtpUserSuccess) {
  return { type: LOGIN, payload, onLoginSuccess, onLoginFailed, onLoginOtpSuccess, loginOtpUserSuccess };
}
